...
2. Run `python .claude/skills/asd-ste100/scripts/ste-lint.py --fail-over 2.5 draft.md`.
3. Fix the reported categories. Lint one more time. Two passes, no more.
4. Send the reply one time.

```
python .claude/skills/asd-ste100/scripts/ste-lint.py draft.md            # flavored target: under 2.5 per 100 words
python .claude/skills/asd-ste100/scripts/ste-lint.py --strict draft.md   # strict target: under 1.5 per 100 words
python .claude/skills/asd-ste100/scripts/ste-lint.py --shape draft.md    # add the Layer 2 counts
```
