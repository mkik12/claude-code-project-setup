...
1. Check the **Initialized** field in CLAUDE.md's "## Project status". If it is
...
4. Tell the user, in their language and at their detail level: the URL to open,
   what they should see, how to try the main feature, and that `/kill` stops the
   app when they are done.
